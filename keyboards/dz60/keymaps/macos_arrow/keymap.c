...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Ctrl | Alt  | Gui  |                Space               |  Gui  | _ML | Left| Down|Right|
   * `-----------------------------------------------------------------------------------------'
   */
  [_BL] = LAYOUT_2_shifts(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_RGUI, MO(_ML), KC_LEFT, KC_DOWN, KC_RIGHT),
  ...
  [_FL] = LAYOUT(
    ...
    ______, ______, KC_MS_U, ______, ______, ______, ______, KC_BTN1, KC_BTN2, ______, ______, ______, ______, ______,
    ______, KC_MS_L, KC_MS_D, KC_MS_R, ______, ______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, ______, ______, ______,
